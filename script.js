...
const deckCards = ["erika_sendo.jpg", "erika_sendo.jpg", "inuyasha.jpg", "inuyasha.jpg", "jetfire.jpg", "jetfire.jpg", "korrina.jpg", "korrina.jpg", "madison_taylor.jpg", "madison_taylor.jpg", "megaman.jpg", "megaman.jpg", "optimus_prime.jpg", "optimus_prime.jpg", "roll.jpg", "roll.jpg"];
...
function startGame() {
  ...
  for (let i = 0; i < shuffledDeck.length; i++) {
    ...
    addImage.setAttribute("src", "img/cards/" + shuffledDeck[i]);
    // Add an alt tag to the image
    addImage.setAttribute("alt", "Anime Character");
